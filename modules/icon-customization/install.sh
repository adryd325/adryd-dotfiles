...
if [[ -e "/usr/share/applications/signal.desktop" ]]; then
    sudo cp -f ./icons/signal-512.png /usr/share/icons/hicolor/512x512/apps/signal.png
    sudo cp -f ./icons/signal-256.png /usr/share/icons/hicolor/256x256/apps/signal.png
    sudo cp -f ./icons/signal-128.png /usr/share/icons/hicolor/128x128/apps/signal.png
fi
...
if [[ -e "/var/lib/flatpak/app/io.gitlab.librewolf-community/current/active/" ]]; then
    sudo cp -f ./icons/librewolf-256.png /var/lib/flatpak/app/io.gitlab.librewolf-community/current/active/files/share/icons/hicolor/128x128/apps/io.gitlab.librewolf-community.png
fi
